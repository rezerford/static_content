...
/**
 * Staticcontent Component Controller
 */
class StaticcontentController extends JControllerLegacy
{
        /**
         * display task
         *
        ...
        {
        	require_once(JPATH_BASE.'/components/com_staticcontent/assets/Snoopy.class.php' );
			$jq_version = JoomlaquizHelper::getVersion();
			$s = new Snoopy();
			$s->read_timeout = 90;
			$s->referer = JURI::root();
			@$s->fetch('http://www.joomplace.com/version_check/componentVersionCheck.php?component=staticcontent&current_version='.urlencode($jq_version));
        ...
        public function latestNews()
        {
			...
			$s->read_timeout = 10;
			$s->referer = JURI::root();
			@$s->fetch('http://www.joomplace.com/news_check/componentNewsCheck.php?component=staticcontent');
			$news_info = $s->results;
